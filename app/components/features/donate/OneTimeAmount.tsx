...
export const OneTimeAmount: FC<{
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-3">
      <p className="text-sm font-medium dark:text-zinc-300 text-neutral-700">Select a one time donation: </p>
      <div className="grid grid-cols-1 gap-3">
        {ONE_TIME_PLANS.map((plan) => (
          <div key={plan.id}>
            ...
            {plan.id === 'once-custom' && selectedPlan === 'once-custom' && (
